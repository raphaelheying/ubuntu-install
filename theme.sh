...
echo '🚀 Configurando a fonte...'
sudo apt install -y fonts-jetbrains-mono
gsettings set org.gnome.desktop.interface monospace-font-name 'JetBrains Mono 11'
PROFILE_ID=$(gsettings get org.gnome.Terminal.ProfilesList default | tr -d \')
PROFILE_PATH=/org/gnome/terminal/legacy/profiles:/:$PROFILE_ID/
gsettings set $PROFILE_PATH font 'JetBrains Mono 11'
gsettings set org.gnome.desktop.interface font-name 'JetBrains Mono 11'
gsettings set org.gnome.desktop.wm.preferences titlebar-font 'JetBrains Mono Bold 11'
